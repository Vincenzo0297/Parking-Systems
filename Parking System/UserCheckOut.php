<?php
    ...
    if(isset($_POST['LocationID'])) {
        ...
        $userID = $_POST['userID'];
        $userInfoStatement = "SELECT * FROM users WHERE userID = $userID";
        $userInfoQuery = mysqli_query($con, $userInfoStatement);
        $userRow = mysqli_fetch_assoc($userInfoQuery);
    }
    ...
    if(isset($_POST['submit'])) {
        ...
        if(mysqli_num_rows($systemStatement) > 0) {
            ...
            $updateSystem = "UPDATE systems SET EndHour ='$EndHours', EndMinutes = '$EndMinutes', TotalCost ='$TotalCost' 
                WHERE userID ='$userID' AND LocationID = '$locationID' AND StartHour IS NOT NULL AND EndHour = 0";
...
<body>
    <form action="UserCheckOut.php" method="POST">
        ...
        <h2>User Check Out Parking Location</h1>
